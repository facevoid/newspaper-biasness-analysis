MALE_WORDS_RUSSIAN = ['он', 'сын', 'его', 'его', 'отец', 'человек', 'мальчик', 'сам', 'мужчина', 'брат', 'сыновья', 'отцы', ' мужчины',' мальчики',' мужчины',' братья',' дядя',
'дяди', 'племянник', 'племянники']

MALE_WORDS_GERMAN = ['er', 'Sohn', 'sein', 'er', 'Vater', 'Mann', 'Junge', 'sich', 'männlich', 'Bruder', 'Söhne', 'Väter', ' Männer',' Jungen',' Männer',' Brüder',' Onkel',
'Onkel', 'Neffe', 'Neffen']

MALE_WORDS_FRENCH = ['il', 'fils', 'son', 'lui', 'père', 'homme', 'garçon', 'lui-même', 'homme', 'frère', 'fils', 'pères', ' hommes', 'garçons', 'hommes', 'frères', 'oncle',
'oncles', 'neveu', 'neveux']
...
MALE_WORDS_SPANISH = ['él', 'hijo', 'su', 'él', 'padre', 'hombre', 'niño', 'él mismo', 'hombre', 'hermano', 'hijos', 'padres', ' hombres',' niños',' hombres',' hermanos',' tío',
'tíos', 'sobrino', 'sobrinos']

#female words
FEMALE_WORDS_RUSSIAN = ['она', 'дочь', 'ее', 'ее', 'мать', 'женщина', 'девушка', 'сама', 'женщина', 'сестра', 'дочери', 'матери', ' женщины',
'девочки', 'женщины', 'сестры', 'тетя', 'тети', 'племянница', 'племянницы']

FEMALE_WORDS_GERMAN = ['sie', 'Tochter', 'ihre', 'sie', 'Mutter', 'Frau', 'Mädchen', 'sich', 'weiblich', 'Schwester', 'Töchter', 'Mütter', ' Frauen',
'Mädchen', 'Frauen', 'Schwestern', 'Tante', 'Tanten', 'Nichte', 'Nichten']

FEMALE_WORDS_FRENCH = ['elle', 'fille', 'sienne', 'elle', 'mère', 'femme', 'fille', 'elle-même', 'femme', 'sœur', 'filles', 'mères', ' femmes',
'filles', 'femen', 'sœurs', 'tante', 'tantes', 'nièce', 'nièces']
...
'chicas', 'femen', 'hermanas', 'tía', 'tías', 'sobrina', 'sobrinas']
...
'Tänzer', 'Haushälterin', 'Buchhalter', 'Physiker', 'Gärtner', 'Zahnarzt', 'Weber', 'Schmied', 'Psychologe', 'Vorgesetzter',
...
'Bäcker', 'Administrator', 'Architekt', 'Sammler', 'Bediener', 'Chirurg', 'Fahrer', 'Maler', 'Dirigent', 'Krankenschwester', 'Koch', 'Ingenieur',
...
european_language_word_list = {
    'ru': {
        'male_words': MALE_WORDS_RUSSIAN,
        'female_words': FEMALE_WORDS_RUSSIAN,
        'pr_occupations': PROFESSIONAL_OCCUPATIONS_RUSSIAN
    },

    'de': {
        'male_words': MALE_WORDS_GERMAN,
        'female_words': FEMALE_WORDS_GERMAN,
        'pr_occupations': PROFESSIONAL_OCCUPATIONS_GERMAN
    },
    'fr': {
        'male_words': MALE_WORDS_FRENCH,
        'female_words': FEMALE_WORDS_FRENCH,
        'pr_occupations': PROFESSIONAL_OCCUPATIONS_FRENCH
    },
    'en': {
    ...
    'tr': {
        'male_words': MALE_WORDS_TURKISH,
        'female_words': FEMALE_WORDS_TURKISH,
        'pr_occupations': PROFESSIONAL_OCCUPATIONS_TURKISH
    },
    'it': {
        'male_words': MALE_WORDS_ITALIAN,
        'female_words': FEMALE_WORDS_ITALIAN,
        'pr_occupations': PROFESSIONAL_OCCUPATIONS_ITALIAN
    },
    'es': {
        'male_words': MALE_WORDS_SPANISH,
        'female_words': FEMALE_WORDS_SPANISH,
        'pr_occupations': PROFESSIONAL_OCCUPATIONS_SPANISH
    }
}